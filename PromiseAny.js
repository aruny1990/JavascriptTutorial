...
//However , unlike Promise.race(), Promise.any() doesn't reject simultaneously when the first promise rejects
//instead it waits until one promise fulfiled/resolved
...
.catch(errors=>{
    console.error("All promise rejected:",errors); //will log all the rejection if all promise reject
});